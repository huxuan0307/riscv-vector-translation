...
![image-20210904231942766](img/vsetvl-format.png)
...
这部分请参考1.0版本的翻译文档第7章节 向量访存指令。

## 3. 内存原子扩展指令

第8章节（8. Vector AMO Operations (Zvamo)）原子内存操作指令在0.9版本被重新设计，包括指令名和编码等。

1.0版本将Zvamo从向量拓展指令手册中移除，放进独立的Zvamo拓展中。
